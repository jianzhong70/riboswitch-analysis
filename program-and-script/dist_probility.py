...
file_paths_3lxl = ['E:/cjzdata2/riboswitch3/riboswitchdat/3d2gdat/mddat/79-66.dat', 
              'E:\cjzdata2\/riboswitch3\/riboswitchdat\/3d2vdat\mddate\/80-66.dat',
              'E:/cjzdata2/riboswitch3/riboswitchdat/3d2xdat/mddat/79-66.dat']
labels_3lxl = ['TPP', 'PYI','D2X']
#labels_3lxk = ['MI1-WT', 'MI1-SP', 'MI1-DP']
colors = ['red', 'green', 'cyan']

save_path_3lxl = 'E:/cjzdata2/riboswitch3/riboswitchdat/timepicture/rmsf_images/mg-66-fre.png'
...
xlabel = 'System indexes'
ylabel = 'Mg-G66 distance(Å)'
